...
CliOptions::CliOptions(int argc, char** argv) {
  try {
    ...
    options.add_options()(
        ...
        cxxopts::value<std::string>()->default_value("image.raw"))(
        "b,bufsize", "Buffer size when reading image",
        cxxopts::value<size_t>()->default_value("4096"))(
        "m,minsize", "Minimum file size to consider",
        cxxopts::value<size_t>()->default_value("20000"))(
        "n,threads", "Number of threads to spawn",
